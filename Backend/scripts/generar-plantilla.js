...
async function main() {
  ...
  const datosProductos = [
    // id_orig, sku,              nombre,                               marca,       seccion,       categoria,        subcategoria,    desc_corta,                                                     proveedor,                  publicado, destacado, moneda, caracteristicas
  ...
  console.log(`   ↳ Hoja 1: 13 columnas — ID, SKU, Nombre, Marca, Sección, Categoría, Subcategoría, Desc, Proveedor, Publicado, Destacado, Moneda, Características`);
