            ...
            <MainContent>
                <Hero id="hero">
                    <LeftColumn>
                        ...
                        <Subtitle>
                            Desarrollamos experiencias digitales <b>modernas, dinámicas y totalmente responsive</b>. Creamos plataformas flexibles y fácilmente modificables que se adaptan al crecimiento de tu marca, asegurando una presencia web profesional en cualquier dispositivo.
                        </Subtitle>

                        <FeatureGrid>
                            <Feature>
                                Interfaz fluida y adaptativa diseñada para una navegación impecable en móviles, tablets y computadoras.
                            </Feature>
                            <Feature>
                                Arquitectura dinámica con gestor de contenidos intuitivo, permitiendo actualizaciones rápidas y modificaciones sencillas.
                            </Feature>
                        </FeatureGrid>
                    </LeftColumn>
                ...
                <PlansSection id="plans">
                    <SectionTitle>Plan Propuesto</SectionTitle>
                    <PlansGrid>
                        {/* Unified Full Plan */}
                        <PlanCard className="wide-card">
                            <PlanHeader>
                                <PlanTitle>Desarrollo Web + Diseño + Gestor de Contenidos</PlanTitle>
                            ...
                            <PlanFeatures className="dual-column">
                                ...
                                <PlanFeature>Estructura web completa: Home, Productos, Servicios, Quiénes Somos y Contacto</PlanFeature>
                                <PlanFeature>Página individual de cada Producto/Servicio detallado</PlanFeature>
                    ...
                    <MaintenanceBanner>
                        <BannerContent>
                            ...
                            <PriceContainer>
                                <MonthlyBreakdown>$25.000/mes</MonthlyBreakdown>
                            </PriceContainer>
                        </BannerContent>
                    </MaintenanceBanner>
                </PlansSection>
