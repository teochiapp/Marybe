            ...
            <MainContent>
                <Hero id="hero">
                    <LeftColumn>
                        ...
                        <JobTitle>Del mar a tu mesa</JobTitle>

                        <Subtitle>
                            Ofrecemos el desarrollo de una plataforma digital diseñada para potenciar su pescadería, facilitando la exhibición de productos, la gestión de pedidos online y la entrega directa a sus clientes.
                        </Subtitle>


                        <FeatureGrid>
                            <Feature>
                                Diseño web moderno y atractivo que resalta la frescura y calidad de sus productos.
                            </Feature>
                            <Feature>
                                Plataforma autoadministrable que permite actualizar precios, productos y gestionar pedidos de manera simple y eficiente.
                            </Feature>
                        </FeatureGrid>
                    ...
                    <RightColumn>
                        <PhotoWrapper>
                            <ProfileCard
                                name="Villa Mar Alimentos"
                                handle="VillaMarAlimentos"
                                status="Online"
                                contactText=""
                                avatarUrl="/presupuestos/mar-alimentos-profile.png"
                                showUserInfo={false}
                                enableTilt={true}
                ...
                <PlansSection id="plans">
                    ...
                    <PlansGrid>
                        ...
                        <PlanCard>
                            <PlanHeader>
                                <PlanTitle>Web Institucional (Pedidos vía WhatsApp)</PlanTitle>
                                <PlanPrice>$650.000</PlanPrice>
                            ...
                            <PlanFeatures>
                                <PlanFeature>Diseño web único personalizado</PlanFeature>
                                <PlanFeature>Configuración e arquitectura inicial</PlanFeature>
                                <PlanFeature>Landing Page + Cabecera/Footer</PlanFeature>
                                <PlanFeature>Página Catálogos por Categoría</PlanFeature>
                                <PlanFeature>Página individual de cada Producto</PlanFeature>
                                <PlanFeature>Paginas Nosotros, Contacto, Novedades y más</PlanFeature>
                                <PlanFeature>Pagina de Carrito y Pago (WhatsApp)</PlanFeature>
                                <PlanFeature>Desarrollo y revisión responsive (Mobile y Tablet)</PlanFeature>
                                <PlanFeature>Creación panel para cambiar contenidos</PlanFeature>
                        ...
                        <PlanCard>
                            ...
                            <PlanFeatures>
                                ...
                                <PlanFeature>Integración de pasarela de pago (Mercado Pago / MODO / etc)</PlanFeature>
                                <PlanFeature>Configuración de métodos de envío y cálculo automático</PlanFeature>
                                <PlanFeature>Gestión de stock</PlanFeature>
                                <PlanFeature>Panel de gestión de pedidos</PlanFeature>
                                <PlanFeature>Emails automáticos de confirmación de compra</PlanFeature>
                                <PlanFeature>Recuperación de carrito abandonado</PlanFeature>
                                <PlanFeature>Creación y gestión de ofertas, descuentos o precios promocionales</PlanFeature>
                            </PlanFeatures>

                            <PlanFooter>
                                <FiClock /> Tiempo estimado: 4 semanas
                            </PlanFooter>
                        </PlanCard>
                    </PlansGrid>
                ...
                <ClarificationsSection id="notices">
                    ...
                    <ClarificationText>
                        Todo esto cubriría lo necesario para tener una página web funcional y estéticamente agradable. Con excepción del dominio que se vaya a usar (ej: villamaralimentos.com o villamaralimentos.com.ar),
